...
function StaffDocumentos({ departamento = 'comercial', activo = 'documentos', titulo = 'Documentos de clientes' }) {
  ...
  useEffect(() => {
    let vivo = true
    staffApi.get('/staff/documentos')
      .then(({ data }) => { if (vivo) setSolicitudes(Array.isArray(data) ? data : []) })
...
export default StaffDocumentos